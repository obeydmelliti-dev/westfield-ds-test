...
export declare const DEFAULT_PARSERLESS_INCLUDE_GLOBS: string[];
...
export declare function determineConfigFromProject(dir: string, isTemplatesOnlyCLI?: boolean): FigmaConfig;

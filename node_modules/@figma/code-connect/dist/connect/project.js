...
exports.DEFAULT_LABEL_PER_PARSER = exports.DEFAULT_PARSERLESS_INCLUDE_GLOBS = exports.DEFAULT_INCLUDE_GLOBS_BY_PARSER = void 0;
...
exports.DEFAULT_PARSERLESS_INCLUDE_GLOBS = [
    '**/*.figma.ts',
    '**/*.figma.js',
    '**/*.figma.template.ts',
    '**/*.figma.template.js',
...
function determineConfigFromProject(dir, isTemplatesOnlyCLI = false) {
    ...
    logging_1.logger.info(`Can't determine parser from project. Proceeding without a parser.`);
    return { codeConnect: label ? { label } : {} };
}
